class VendingMachine:
    ...
    def restock(self, added_num):
        self.stock += added_num
        return 'Current {1} stock: {0}'.format(self.stock, self.item)
    ...
    def vend(self):
        if self.stock == 0:
            ...
            self.stock -= 1
            if change > 0:
                return 'Here is your {1} and ${0} change.'.format(change, self.item)
            else:
