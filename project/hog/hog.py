...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        t = gcd(player_score, opponent_score)
        if t >= 10:
            return True
        else:
            return False
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    res = 10
    for i in range(1, 11):  
        last = make_averaged(roll_dice, trials_count)(res, dice)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if extra_turn(score + free_bacon(opponent_score), opponent_score) or (not bacon_strategy(score, opponent_score, cutoff, num_rolls)):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
